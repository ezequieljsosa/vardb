...
class TestVcfLoad(unittest.TestCase):
    ...
    def test_repeated(self):       
        ...
        with self.assertRaises(VariantCollectionExistsError):
            self.db.load_variants(VcfSnpeffIO.parse(data), self.ref_organism, self.sample,1)
    ...
    def test_2_load(self):
        ...
        self.db.load_variants(VcfSnpeffIO.parse(data), self.ref_organism, self.sample+"2",1)
